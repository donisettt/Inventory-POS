                ...
                <form action="<?= base_url() ?>laporan/barang_keluar_pdf" method="POST" target="_blank">
                    <div class="row">
                        <div class="col-lg-3 mb-4">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-primary" type="button" id="date1">
                        ...
                        <div class="col-lg mb-4">
                            ...
                            <a href="#" class="btn btn-md btn-danger btn-icon-split mb-4" onclick="reset()">
                            ...
                            <button type="submit" class="btn btn-md btn-success btn-icon-split mb-4">
