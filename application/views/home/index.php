        ...
        <div class="col-xl-3 col-md-6 mb-4" id="supplier">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Supplier
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlsupplier ?> Supplier</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlcustomer ?> Customer</div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jmlUser ?> User</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                <h6 class="m-0 font-weight-bold border-0 text-white">Panel Informasi <i class="fas fa-info-circle"></i></h6> 
            </div>
            <div class="card-body">
                <h6 class="m-0 font-weight-bold border-0 text-blck">
        ...
        <div class="col-xl-6 col-lg-6">
            ...
            <div class="card-body">
                <h6 class="m-0 font-weight-bold border-0 text-blck">SI-IVEN MARDONI JAYA</h6><br>
                <p>Aplikasi inventaris Gudang Dengan Penerapan Rancangan Metode Scrum</p>
                <p>
                    Bahasa Pemrograman :
                    PHP, JavaScript <br>
                    Framework :
                    CodeIgniter 3, Sb Admin 2 <br>
                    Database :
                    MySQL <br>
                    Code Editor :
